...
def create_installation_and_deployment_api(ip):
    return ansible_acp_azure_utility.InstallationAndDeploymentOfAPEXCloudPlatformForMicrosoftAzureApi(
        ansible_acp_azure_utility.ApiClient(OSProvision.create_configuration(ip)))
